$(document).ready(function(){
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    let successAlert = '<div class="alert alert-success alert-dismissible">' + 
                                            ...
                                            '<strong> dentista actualizado </strong></div>'

                 
                    $("#tr_" + dentistaId + " td.td_first_name").text(dentista.nombre.toUpperCase());
                    $("#tr_" + dentistaId + " td.td_last_name").text(dentista.apellido.toUpperCase());
    ...
    $(document).on("click", "table button.btn_id", function(){
        ...
        $.ajax({
            ...
            success: function(response) {
                let dentista = response;
                $("#dentistas_id").val(dentista.id);
                $("#nombre").val(dentista.nombre);
                $("#apellido").val(dentista.apellido);
